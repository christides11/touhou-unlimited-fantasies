...
namespace TAPI.Combat
{
    public class AttackDefinitionEditorWindow : CAF.Combat.AttackDefinitionEditorWindow
    {
        ...
        private void HitboxesMenu()
        {
            ...
            {
                attack.hitboxGroups.Add(new BoxGroup());
            }
            ...
            if(GUILayout.Button("Copy", GUILayout.Width(60)))
            {
                ...
                {
                    copyCurrent = new BoxGroup(attack.hitboxGroups[currentHitboxGroupIndex]);
                }
            }
            if(GUILayout.Button("Paste", GUILayout.Width(60)))
            {
                ...
                {
                    attack.hitboxGroups[currentHitboxGroupIndex] = new BoxGroup(copyCurrent);
                }
                copyCurrent = null;
            }
            EditorGUILayout.EndHorizontal();
            ...
            BoxGroup currentGroup = attack.hitboxGroups[currentHitboxGroupIndex];
            DrawHitboxGroup(currentGroup);
        }

        bool hitboxesFoldout;
        private void DrawHitboxGroup(BoxGroup currentGroup)
        {
        ...
        private void DrawHitboxGroupGrabOptions(BoxGroup currentGroup)
        {
        ...
        private void DrawHitboxGroupHitOptions(BoxGroup currentGroup)
        {
